...
sgs = [
  {
    ...
    ingress = [{
      description = "The rule allows availability traffic from the load balancer's range of addresses"
      protocol    = "TCP"
    ...
    },
    {
      ...
      protocol    = "ANY"
      cidr4       = ["10.233.64.0/18","10.233.0.0/18"]
      from_port   = 0
      to_port     = 65535
    },
    {
      ...
      protocol    = "ICMP"
      cidr4       = ["10.0.0.0/8","192.168.0.0/16","172.16.0.0/12"]
    },
    {
    ...
    {
      description = "The rule allows connection on 80 port from the Internet"
      protocol    = "TCP"
      cidr4       = ["0.0.0.0/0"]
      port        = 80
    },
